...
body{background:var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,Ubuntu,sans-serif;min-height:100vh;line-height:1.5}
...
textarea{resize:vertical;font-family:'SF Mono',Monaco,'Cascadia Code',monospace}
...
.paste-textarea{height:400px;font-family:'SF Mono',Monaco,'Cascadia Code',monospace;font-size:14px;line-height:1.5}
.result{margin-top:16px;padding:16px;background:var(--surface);border:1px solid var(--border);border-radius:8px;display:none}
.link-box{display:flex;gap:8px;align-items:center;margin-top:8px}
.link-box input{flex:1;font-family:monospace;font-size:14px;background:var(--bg);border:1px solid var(--border);color:var(--text);padding:10px;border-radius:8px}
...
.content{font-family:'SF Mono',Monaco,'Cascadia Code',monospace;white-space:pre-wrap;color:var(--text);line-height:1.6;font-size:14px}
